...
export default async function WhatIsSeoPage() {
  const t = await getTranslations("guideSeo");
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="pb-20" aria-labelledby="seo-checklist-title">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-slate-50 border border-slate-100 rounded-4xl p-8 md:p-10">
            <h2
              id="seo-checklist-title"
      ...
      <section className="pb-10" aria-labelledby="seo-related-service-title">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="rounded-4xl border border-slate-200 bg-slate-50 p-8 md:p-10">
            <h2
              id="seo-related-service-title"
