...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({
    locale,
    namespace: "guideProcurement.seo",
  });
...
export default async function WebProcurementChecklistPage() {
  const t = await getTranslations("guideProcurement");
  ...
  return (
    <div className="min-h-screen bg-white">
      <section
        ...
        aria-labelledby="procurement-guide-title"
      >
        <div className="container mx-auto px-6">
          <h1
            id="procurement-guide-title"
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-8 md:p-10">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 text-brand-navy font-bold hover:text-brand-green transition-colors"
            >
