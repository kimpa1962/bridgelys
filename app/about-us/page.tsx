        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 id="network-title" className="font-display text-3xl md:text-4xl font-bold mb-8">
              En specialist, ett helt <span className="text-brand-green-on-dark">nätverk av kraft</span>
            </h2>
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-12">
              {networkTags.map((tag) => (
                <span key={tag} className="px-4 py-2 bg-white/5 border border-white/10 rounded-full text-sm font-medium text-brand-green-on-dark">
                  {tag}
                </span>
              ))}
            </div>
